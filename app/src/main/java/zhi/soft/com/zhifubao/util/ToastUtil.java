...
import zhi.soft.com.zhifubao.BaseApp;
...
public class ToastUtil {
    ...
    public static void showCustomToastLong(String msg) {
        showCustomToastBase(msg, true, SHOW_DEFAULT_ICON);
    }

    public static void showCustomToastShort(String msg) {
        showCustomToastBase(msg, false, SHOW_DEFAULT_ICON);
    }

    public static void showCustomToastShort(String msg, int res) {
        showCustomToastBase(msg, false, res);
    }

    private static void showCustomToastBase(final String msg, final boolean isLong, final int res) {
            ...
            public void run() {
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        synchronized (synObj) {
                            //加载Toast布局
                            View toastRoot = LayoutInflater.from(BaseApp.getInstance()).inflate(R.layout.toast_base, null);
                            //初始化布局控件
                            ...
                            //Toast的初始化
                            Toast toastStart = new Toast(BaseApp.getInstance());
                    ...
                    public void run() {
                        synchronized (synObj) {
                            if (toast != null) {
                                ...
                                if (ctx == null)
                                    toast = Toast.makeText(BaseApp.getInstance(), msg, Toast.LENGTH_SHORT);
                                else
